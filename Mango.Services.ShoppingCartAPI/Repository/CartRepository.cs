...
namespace Mango.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartDto> CreateUpdateCart(CartDto cartDto)
        {
            ...
            var productInDb = await _db.Products.FirstOrDefaultAsync(u => u.ProductId ==
            ...
            var cartHeaderFromDb = await _db.CartHeader.AsNoTracking().FirstOrDefaultAsync(u => u.UserId == 
            ...
            else
            {
                ...
                cart.CartDetails.FirstOrDefault().ProductId && u.CartHeaderId == cartHeaderFromDb.CartHeaderId);
        ...
        public async Task<bool> RemoveFromCart(int cartDetailsId)
        {
            ...
            int totalCountOfCartItems = _db.CartDetails
                .Where(u => u.CartHeaderId == cartDetailsId).Count();
